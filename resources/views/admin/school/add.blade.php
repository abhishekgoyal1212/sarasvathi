            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{route('school.insert')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                {{--
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="reg_no" class="form-control" id="reg_no" value="{{old('reg_no')}}">
                                @error('reg_no')
                                <div class="form-valid-error">{{ $message }}</div>
                                @enderror
                            </div>
