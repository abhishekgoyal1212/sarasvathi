            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="{{route('student.insert')}}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="board">
                                        ...
                                        <option value="{{$board_info->id}}" {{old('board')==$board_info->id ? 'selected' : '' }}>{{$board_info->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('board')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="class">
                                        ...
                                        <option value="{{$class_info->id}}" {{old('class')==$class_info->id ? 'selected' : '' }}>{{$class_info->name.' '.$class_info->stream_select }}</option>
                                        @endforeach
                                    </select>
                                    @error('class')
                                    <div class="form-valid-error">{{ $message }}</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="country_code">
                                        ...
                                        <option value="{{$code_info->mobile_code}}" {{old('country_code')==$code_info->mobile_code ? 'selected' : '' }}>{{$code_info->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('country_code')
                                    <div class="form-valid-error">{{ $message }}</div>
