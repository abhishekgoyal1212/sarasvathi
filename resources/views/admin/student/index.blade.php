            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('student.add')}}"><button type="button" class="btn btn-primary">Add Student</button></a>
                    </div>
                    <div class="card-body">
                        <table id="data-table" class="table table-hover table-bordered table-striped el-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('student.edit',[$single_info->id])}}"><button type="button" class="btn btn-block bg-gradient-primary btn-xs my-1">Edit</button></a>
                                        <!-- <a href="{{route('student.delete',[$single_info->id])}}" onclick="return confirm('Are you sure to delete student?')"><button type="button" class="btn btn-block bg-gradient-danger btn-xs my-1">Delete</button></a> -->
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
