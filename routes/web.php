...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    //----------------------------STUDENT----------------------------------------
    Route::get('/freelancer-student', [StudentController::class, 'freelancer_student'])->name('student.freelancer');
    Route::get('/school-student', [StudentController::class, 'school_student'])->name('student.school');
    Route::get('/details-student/{id}', [StudentController::class, 'details_student'])->name('student.details');
});
...
Route::prefix('tutor')->middleware('auth:tutor')->group(function () {
    // Route::prefix('admin')->group(function () {
    Route::view('/dashboard', 'tutor/dashboard')->name('tutor.dashboard');
    Route::get('/profile', [ProfileController::class, 'index'])->name('admin.getProfile');
    Route::post('/save-profile', [ProfileController::class, 'save_profile'])->name('admin.setProfile');
...
Route::prefix('school')->middleware('auth:school')->group(function () {
    ...
    Route::view('/dashboard', 'school/dashboard')->name('school.dashboard');
    Route::get('/profile', [ProfileController::class, 'index'])->name('admin.getProfile');
    Route::post('/save-profile', [ProfileController::class, 'save_profile'])->name('admin.setProfile');
...
Route::prefix('instructor')->middleware('auth:instructor')->group(function () {
    ...
    Route::view('/dashboard', 'school/instructor/dashboard')->name('instructor.dashboard');
    Route::get('/profile', [ProfileController::class, 'index'])->name('admin.getProfile');
    Route::post('/save-profile', [ProfileController::class, 'save_profile'])->name('admin.setProfile');
